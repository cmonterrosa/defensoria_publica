class CreateAudiencias < ActiveRecord::Migration
  def self.up
    create_table :audiencias do |t|
      t.datetime :fechahora_solicitud, :fechahora_atencion
      t.integer :turno, :persona_id, :defensor_id, :estado_audiencia_id
    ...
    add_index :audiencias, :persona_id, :name => "audiencias_defensor"
